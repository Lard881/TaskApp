            ...
            GoRoute(
              ...
              builder: (_, state) => TasksScreen(
                initialFilter: state.extra != null
                    ? (state.extra as Map<String, dynamic>)['filter']
                          as FilterTab?
                    : null,
              ),
            ),
          ...
          routes: [
            GoRoute(
              ...
              routes: [
                ...
                GoRoute(path: 'security', builder: (_, _) => const Scaffold()),
                GoRoute(path: 'help', builder: (_, _) => const Scaffold()),
                GoRoute(path: 'about', builder: (_, _) => const Scaffold()),
                GoRoute(path: 'language', builder: (_, _) => const Scaffold()),
                GoRoute(path: 'timezone', builder: (_, _) => const Scaffold()),
              ],
            ),
          ],
        ),
