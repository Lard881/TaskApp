...
void main() {
  ...
  group('RelativeTimeFormatter.formatRelative', () {
    final now = DateTime(2024, 6, 15, 12); // fixed reference
    ...
    test('exactly 1 calendar day ago → "Yesterday"', () {
      ...
      final yesterday = DateTime(2024, 6, 14, 12);
      expect(
    ...
    test('2 calendar days ago → "2 days ago"', () {
      final ts = DateTime(2024, 6, 13, 12);
      expect(
    ...
    test('30 days ago → absolute date', () {
      final ts = DateTime(2024, 5, 16, 12);
