...
class _InviteTeammatesScreenState extends ConsumerState<InviteTeammatesScreen> {
  String? _inviteCode;
  ...
  Future<void> _generateInviteLink() async {
    ...
    try {
      ...
      final code = await repo.createInvite(workspaceId: widget.workspaceId);
      if (context.mounted) {
        setState(() {
          _inviteCode = code;
          _loadingCode = false;
      ...
      if (context.mounted) setState(() => _loadingCode = false);
    }
  }

  String get _inviteLink => 'https://planpal.app/join/$_inviteCode';
  ...
  Widget build(BuildContext context) {
    ...
    final linkBoxColor =
        isDark ? AppColors.darkBackground : const Color(0xFFF5F7FF);
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // ── Step indicator ────────────────────────────────────────────
              _StepIndicator(current: 2, total: 2, isDark: isDark),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              ...
                              onPressed: _inviteCode == null ? null : _copyLink,
