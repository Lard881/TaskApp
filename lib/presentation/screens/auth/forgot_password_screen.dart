...
class _ForgotPasswordScreenState
  ...
  Future<void> _submit() async {
    ...
    try {
      print('🔵 Calling resetPassword for: ${_emailCtrl.text.trim()}');
      await ref
          .read(authProvider.notifier)
          .resetPassword(_emailCtrl.text.trim());
      print('✅ resetPassword call completed');
      if (context.mounted) {
        setState(() { _loading = false; _sent = false; });
        // Navigate to code verification screen
        context.push('/reset-password/verify', extra: _emailCtrl.text.trim());
      }
    } catch (e) {
