...
import 'package:planpal/presentation/screens/home/widgets/calendar_schedule_sheet.dart';
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                              DateTimeFormatter.greetingLine(firstName, now),
                              style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.w800,
                                color: isDark ? AppColors.darkOnSurface : AppColors.lightOnSurface,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: _QuickActionTile(
                            ...
                            onTap: () => CalendarScheduleSheet.show(context),
                          ),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 11, color: isDark ? AppColors.darkOnSurfaceMuted : Colors.grey.shade500),
          ),
          const Spacer(),
