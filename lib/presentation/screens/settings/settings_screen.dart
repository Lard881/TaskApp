...
import 'package:planpal/presentation/screens/settings/widgets/rate_app_dialog.dart';
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _SettingsCard(
                    children: [
                      ...
                      _SettingsRow(
                        ...
                        badgeColor: notifOn ? AppColors.success : Colors.grey,
                  ...
                  _SettingsCard(
                    children: [
                      ...
                      _SettingsRow(
                        ...
                        onTap: () => context.go('/settings/timezone'),
                      ),
                    ],
                  ),
                  ...
                  // Support & Legals
                  const _SectionLabel('SUPPORT & LEGALS'),
                  _SettingsCard(
                    children: [
                      _SettingsRow(
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        backgroundColor: AppColors.logOutRed.withValues(alpha: 0.05),
...
class _ThemeModal extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final current =
        ref.watch(preferencesProvider).valueOrNull?.themeMode ??
        ThemeMode.light;
  ...
  Widget _option(
    ...
    return ListTile(
      ...
      trailing: current == mode
          ...
          : null,
      onTap: () async {
        await ref.read(preferencesProvider.notifier).setTheme(mode);
