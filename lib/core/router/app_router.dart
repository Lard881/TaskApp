...
import 'package:planpal/presentation/screens/auth/verify_code_screen.dart';
import 'package:planpal/presentation/screens/auth/set_new_password_screen.dart';
import 'package:planpal/presentation/screens/auth/reset_password_screen.dart';
...
import 'package:planpal/presentation/screens/workspace/workspace_hub_screen.dart';
...
String? _redirect(AppAuthState authState, String location) {
  ...
  switch (authState) {
    ...
    case AppAuthState.authenticated:
      ...
      // Only the initial welcome choice screen redirects to home for authenticated users.
      // Workspace creation flows (/onboarding/create-workspace, /onboarding/invite) remain accessible.
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: [
          ...
          StatefulShellBranch(routes: [
            GoRoute(
              path: '/workspace',
              builder: (_, _) => const WorkspaceHubScreen(),
            ),
          ]),
          ...
          StatefulShellBranch(routes: [
            GoRoute(
              ...
              routes: [
                ...
                GoRoute(
                  path: 'timezone',
                  builder: (_, _) => const TimeZoneSelectionScreen(),
                ),
              ],
            ),
          ]),
